...
<head>
    <title>Code coverage report for src/access-token/Token.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/access-token</a> Token.js</h1>
        <div class='clearfix'>
...
Token.prototype.setToken = function setToken(tokenData) {
  ...
  this.id_token = tokenData.id_token || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
