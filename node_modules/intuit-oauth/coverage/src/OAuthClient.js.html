...
<head>
    <title>Code coverage report for src/OAuthClient.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> OAuthClient.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">70.39% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>252/358</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">59.49% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>166/279</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">64.61% </span>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">72.01% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>247/343</span>
            </div>
...
<a name='L1068'></a><a href='#L1068'>1068</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
function OAuthClient(config) {
  ...
  this.logging = !!(
    Object.prototype.hasOwnProperty.call(config, 'logging') &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >config.logging === true</span>
  );
  this.logger = null;
  this.state = new Csrf();
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.logging) {
    const dir = <span class="cstat-no" title="statement not covered" >'./logs';</span>
...
<span class="cstat-no" title="statement not covered" >    this.logger = winston.createLogger({</span>
      level: 'info',
      format: winston.format.combine(
        winston.format.timestamp({
          format: 'YYYY-MM-DD HH:mm:ss.SSS Z',  // This will include local timezone offset
        }),
        winston.format.printf(<span class="fstat-no" title="function not covered" >(i</span>nfo) =&gt; <span class="cstat-no" title="statement not covered" >`${info.timestamp} ${info.level}: ${info.message}`)</span>,
      ),
      transports: [
...
&nbsp;
  const authUri = `${OAuthClient.authorizeEndpoint}?${queryString.stringify({
    ...
    state: params.state || <span class="branch-1 cbranch-no" title="branch not covered" >this.state.create(this.state.secretSync()),</span>
  })}`;
&nbsp;
...
function safeStringify(obj) {
  try {
    return JSON.stringify(obj, (key, value) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (key === '_redirectable' || key === '_currentRequest' || key === 'socket') {
<span class="cstat-no" title="statement not covered" >        return undefined;</span>
      }
      return value;
    });
  } catch (e) {
<span class="cstat-no" title="statement not covered" >    return String(obj);</span>
  }
}
&nbsp;
/**
...
OAuthClient.prototype.createToken = function createToken(uri) {
  return new Promise((resolve) =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if ('state' in params) this.getToken().state = params.state;
&nbsp;
    const body = {};
    if (params.code) {
...
&nbsp;
    ...
    .then((res) =&gt; {
      const authResponse = Object.prototype.hasOwnProperty.call(res, 'json') ? res : <span class="branch-1 cbranch-no" title="branch not covered" >null;</span>
      const json = (authResponse &amp;&amp; authResponse.json) || <span class="branch-2 cbranch-no" title="branch not covered" >res;</span>
...
&nbsp;
    body.token =
      ...
      (this.getToken().isAccessTokenValid()
        ...
        : <span class="branch-1 cbranch-no" title="branch not covered" >this.getToken().refresh_token)</span>;
&nbsp;
    const request = {
...
<span class="cstat-no" title="statement not covered" >      this.log('error', 'Revoke Token () threw an exception : ', safeStringify(e));</span>
...
&nbsp;
    ...
    .catch(<span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >      this.log('error', 'Get User Info ()  threw an exception : ', safeStringify(e));</span>
<span class="cstat-no" title="statement not covered" >      throw e;</span>
    });
};
&nbsp;
...
&nbsp;
      ...
      return {
        ...
        json: response.data,
        body: typeof response.data === 'string' ? <span class="branch-0 cbranch-no" title="branch not covered" >response.data </span>: JSON.stringify(response.data),
      };
    } catch (error) {
      attempt += 1;
      lastError = error;
&nbsp;
      ...
      const errorAnalysis = {
        ...
        response: error.response ? {
          ...
          fault: error.response.data &amp;&amp; error.response.data.Fault ? <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
            type: error.response.data.Fault.type,
            error: error.response.data.Fault.Error ? error.response.data.Fault.Error.map(<span class="fstat-no" title="function not covered" >er</span>r =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
              message: err.Message,
              detail: err.Detail,
              code: err.code,
              element: err.element,
...
&nbsp;
      ...
      this.log('error', 'Exception Analysis:', {
        ...
        faultType: error.response &amp;&amp; error.response.data &amp;&amp; error.response.data.Fault &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >error.response.data.Fault.type,</span>
        faultErrors: error.response &amp;&amp; error.response.data &amp;&amp; error.response.data.Fault &amp;&amp; <span class="branch-3 cbranch-no" title="branch not covered" >error.response.data.Fault.Error,</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (status === 400) {
<span class="cstat-no" title="statement not covered" >          if (data &amp;&amp; data.Fault) {</span>
            const fault = <span class="cstat-no" title="statement not covered" >data.Fault;</span>
            const faultError = <span class="cstat-no" title="statement not covered" >fault.Error &amp;&amp; fault.Error[0];</span>
            
            // Extract detailed error information from Fault object
            const errorMessage = <span class="cstat-no" title="statement not covered" >(faultError &amp;&amp; faultError.Message) || 'Bad Request';</span>
            const errorCode = <span class="cstat-no" title="statement not covered" >(faultError &amp;&amp; faultError.code) || '400';</span>
            const errorDetail = <span class="cstat-no" title="statement not covered" >(faultError &amp;&amp; faultError.Detail) || 'Request validation failed';</span>
            const faultType = <span class="cstat-no" title="statement not covered" >(fault &amp;&amp; fault.type) || 'ValidationFault';</span>
            
            // Create a more descriptive error message
            const detailedMessage = <span class="cstat-no" title="statement not covered" >`${errorMessage}`;</span>
            
<span class="cstat-no" title="statement not covered" >            throw new OAuthError(</span>
              detailedMessage,
              errorCode,
              errorDetail,
              intuitTid,
              {
                ...
                fault: {
                  type: faultType,
                  errors: fault.Error ? fault.Error.map(<span class="fstat-no" title="function not covered" >er</span>r =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
                    message: err.Message,
                    detail: err.Detail,
                    code: err.code,
                  })) : [],
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (status === 429) {
<span class="cstat-no" title="statement not covered" >          throw new OAuthError(</span>
            'Rate limit exceeded',
            'RATE_LIMIT_EXCEEDED',
...
&nbsp;
        ...
        throw new OAuthError(
          (data &amp;&amp; data.error) || <span class="branch-2 cbranch-no" title="branch not covered" >error.message </span>|| <span class="branch-3 cbranch-no" title="branch not covered" >'Unknown error',</span>
          status === 500 ? 'INTERNAL_SERVER_ERROR' : <span class="branch-1 cbranch-no" title="branch not covered" >status.toString(),</span>
          (data &amp;&amp; data.error_description) || <span class="branch-2 cbranch-no" title="branch not covered" >'An error occurred during the API call',</span>
          intuitTid,
        );
      }
&nbsp;
      ...
      if (error.code === 'ECONNABORTED') {
        throw new OAuthError(
          `Request timeout of ${timeout || <span class="branch-1 cbranch-no" title="branch not covered" >30000}</span>ms exceeded`,
          'TIMEOUT_ERROR',
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (error.request) {
        throw new OAuthError(
...
<span class="cstat-no" title="statement not covered" >    if (attempt &lt; maxRetries) {</span>
      const delay = <span class="cstat-no" title="statement not covered" >2 ** attempt * 1000;</span>
      // eslint-disable-next-line no-await-in-loop
<span class="cstat-no" title="statement not covered" >      await new Promise(<span class="fstat-no" title="function not covered" >re</span>solve =&gt; <span class="cstat-no" title="statement not covered" >setTimeout(resolve, delay))</span>;</span>
    }
  }
&nbsp;
  // If we've exhausted all retries, throw the last error
<span class="cstat-no" title="statement not covered" >  if (lastError) {</span>
<span class="cstat-no" title="statement not covered" >    if (lastError instanceof OAuthError) {</span>
 ...
 */
OAuthClient.prototype.validateIdToken = function <span class="fstat-no" title="function not covered" >validateIdToken(</span>params = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
<span class="cstat-no" title="statement not covered" >    if (!this.getToken().id_token) <span class="cstat-no" title="statement not covered" >throw new Error('The bearer token does not have id_token');</span></span>
&nbsp;
    const id_token = <span class="cstat-no" title="statement not covered" >this.getToken().id_token || params.id_token;</span>
&nbsp;
    // Decode ID Token
    const token_parts = <span class="cstat-no" title="statement not covered" >id_token.split('.');</span>
    const id_token_header = <span class="cstat-no" title="statement not covered" >JSON.parse(atob(token_parts[0]));</span>
    const id_token_payload = <span class="cstat-no" title="statement not covered" >JSON.parse(atob(token_parts[1]));</span>
&nbsp;
    // Step 1 : First check if the issuer is as mentioned in "issuer"
<span class="cstat-no" title="statement not covered" >    if (id_token_payload.iss !== 'https://oauth.platform.intuit.com/op/v1') <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
    // Step 2 : check if the aud field in idToken contains application's clientId
<span class="cstat-no" title="statement not covered" >    if (!id_token_payload.aud.find(<span class="fstat-no" title="function not covered" >(a</span>udience) =&gt; <span class="cstat-no" title="statement not covered" >audience === this.clientId)</span>) <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
    // Step 3 : ensure the timestamp has not elapsed
<span class="cstat-no" title="statement not covered" >    if (id_token_payload.exp &lt; Date.now() / 1000) <span class="cstat-no" title="statement not covered" >return false;</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return resolve(this.getKeyFromJWKsURI(id_token, id_token_header.kid, request));</span>
  })
    .then(<span class="fstat-no" title="function not covered" >(r</span>es) =&gt; {
<span class="cstat-no" title="statement not covered" >      this.log('info', 'The validateIdToken () response is :', safeStringify(res));</span>
<span class="cstat-no" title="statement not covered" >      if (res) <span class="cstat-no" title="statement not covered" >return true;</span></span>
<span class="cstat-no" title="statement not covered" >      return false;</span>
    })
    .catch(<span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >      this.log('error', 'The validateIdToken () threw an exception : ', safeStringify(e));</span>
<span class="cstat-no" title="statement not covered" >      throw e;</span>
    });
};
&nbsp;
 ...
 * @returns {Promise}
 */
OAuthClient.prototype.getKeyFromJWKsURI = function <span class="fstat-no" title="function not covered" >getKeyFromJWKsURI(</span>id_token, kid, request) {
<span class="cstat-no" title="statement not covered" >  return new Promise(<span class="fstat-no" title="function not covered" >(r</span>esolve) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    resolve(this.loadResponse(request));</span>
  })
    .then(<span class="fstat-no" title="function not covered" >(r</span>esponse) =&gt; {
<span class="cstat-no" title="statement not covered" >      if (Number(response.status) !== 200) <span class="cstat-no" title="statement not covered" >throw new Error('Could not reach JWK endpoint');</span></span>
      // Find the key by KID
      const key = <span class="cstat-no" title="statement not covered" >response.data.keys.find(<span class="fstat-no" title="function not covered" >(e</span>l) =&gt; <span class="cstat-no" title="statement not covered" >el.kid === kid)</span>;</span>
      const cert = <span class="cstat-no" title="statement not covered" >this.getPublicKey(key.n, key.e);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return jwt.verify(id_token, cert);</span>
    })
    .catch(<span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >      e = this.createError(e);</span>
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!authResponse.valid()) {
<span class="cstat-no" title="statement not covered" >        throw new OAuthError(</span>
...
&nbsp;
    ...
    .catch(<span class="fstat-no" title="function not covered" >(e</span>) =&gt; {
<span class="cstat-no" title="statement not covered" >      if (!e.authResponse) {</span>
<span class="cstat-no" title="statement not covered" >        e = this.createError(e, authResponse);</span>
      }
<span class="cstat-no" title="statement not covered" >      throw e;</span>
    });
};
...
&nbsp;
OAuthClient.prototype.shouldRetry = function <span class="fstat-no" title="function not covered" >shouldRetry(</span>error, attempt) {
<span class="cstat-no" title="statement not covered" >  if (attempt &gt;= OAuthClient.retryConfig.maxRetries) {</span>
<span class="cstat-no" title="statement not covered" >    return false;</span>
  }
&nbsp;
  // Check if it's a retryable status code
<span class="cstat-no" title="statement not covered" >  if (error.response &amp;&amp; OAuthClient.retryConfig.retryableStatusCodes.includes(error.response.status)) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
  // Check if it's a retryable network error
<span class="cstat-no" title="statement not covered" >  if (error.code &amp;&amp; OAuthClient.retryConfig.retryableErrors.includes(error.code)) {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return false;</span>
...
<span class="cstat-no" title="statement not covered" >        this.currentRequest = null;</span>
        
<span class="cstat-no" title="statement not covered" >        if (this.shouldRetry(error, attempt)) {</span>
<span class="cstat-no" title="statement not covered" >          attempt += 1;</span>
          const delay = <span class="cstat-no" title="statement not covered" >OAuthClient.retryConfig.retryDelay * (2 ** (attempt - 1));</span>
          
<span class="cstat-no" title="statement not covered" >          this.log('warn', `Retrying request (attempt ${attempt}/${OAuthClient.retryConfig.maxRetries})`, {</span>
            error: error.message,
            delay,
            url: request.url,
          });
...
<span class="cstat-no" title="statement not covered" >              resolve(executeRequest());</span>
            }, delay);
          });
        }
&nbsp;
 ...
 * @returns response
 */
OAuthClient.prototype.loadResponseFromJWKsURI = function <span class="fstat-no" title="function not covered" >loadResponseFromJWKsURI(</span>request) {
<span class="cstat-no" title="statement not covered" >  return axios.get(request).then(<span class="fstat-no" title="function not covered" >(r</span>esponse) =&gt; <span class="cstat-no" title="statement not covered" >response)</span>;</span>
};
&nbsp;
/**
...
&nbsp;
  if (authResponse) {
    if (authResponse.body) {
      try {
        const body = typeof authResponse.body === 'string' ? <span class="branch-0 cbranch-no" title="branch not covered" >JSON.parse(authResponse.body) </span>: authResponse.body;
        if (body.error) {
          wrappedError.error = body.error;
          wrappedError.error_description = body.error_description || <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
          wrappedError.message = body.error;
          return wrappedError;
        }
      } catch (e) {
        // If parsing fails, use the original body
<span class="cstat-no" title="statement not covered" >        wrappedError.error = authResponse.body;</span>
<span class="cstat-no" title="statement not covered" >        wrappedError.error_description = authResponse.body;</span>
<span class="cstat-no" title="statement not covered" >        wrappedError.message = authResponse.body;</span>
<span class="cstat-no" title="statement not covered" >        return wrappedError;</span>
      }
    }
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (error instanceof Error) {
    wrappedError.error = error.message;
    wrappedError.message = error.message;
  } else <span class="cstat-no" title="statement not covered" >if (typeof error === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    wrappedError.error = error;</span>
<span class="cstat-no" title="statement not covered" >    wrappedError.message = error;</span>
  } else {
<span class="cstat-no" title="statement not covered" >    wrappedError.error = error.toString();</span>
<span class="cstat-no" title="statement not covered" >    wrappedError.message = error.toString();</span>
  }
&nbsp;
  return wrappedError;
};
...
OAuthClient.prototype.authHeader = function authHeader() {
  ...
  return typeof btoa === 'function' ? btoa(apiKey) : <span class="branch-1 cbranch-no" title="branch not covered" >Buffer.from(apiKey).toString('base64');</span>
};
&nbsp;
/**
 * Log the message
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (this.currentRequest) {
<span class="cstat-no" title="statement not covered" >    logData.request = {</span>
...
<span class="cstat-no" title="statement not covered" >      logData.data = String(data);</span>
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    throw new ValidationError('Empty response received');</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!response.status) {
<span class="cstat-no" title="statement not covered" >    throw new ValidationError('Response missing status code');</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (response.status === 401) {
<span class="cstat-no" title="statement not covered" >    throw new TokenError(</span>
      'Unauthorized',
      'UNAUTHORIZED',
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (response.status === 403) {
<span class="cstat-no" title="statement not covered" >    throw new OAuthError(</span>
      'Forbidden',
      'FORBIDDEN',
